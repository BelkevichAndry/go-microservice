module github.com/BelkevichAndry/go-microservice/shippy-service-consignment
...
require (
	...
	github.com/BelkevichAndry/go-microservice v0.0.0-20200704122337-a01f1ef6fb35 // indirect
